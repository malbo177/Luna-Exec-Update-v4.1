...
[![Stars](https://img.shields.io/github/stars/Luna-Exec-Update-v4.1?style=flat-square)](https://github.com)
...
git clone https://github.com/Luna-Exec-Update-v4.1.git
cd Luna-Exec-Update-v4.1
...
Luna v4.1 runs fully offline, uses under 40 MB of RAM at idle, and ships with more bundled scripts than most paid alternatives — all completely free.
...
<p align="center">
  <b>Luna v4.1</b> — Precision execution, zero compromise. The free Roblox executor built for 2026.
</p>
